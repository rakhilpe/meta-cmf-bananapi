...
#Commented this as after applying this MLOdemo patches fails to apply. Recreated this on top of MLOdemo changes and applied below.
...
#Patches add_group_mgmt_cipher_2_11.patch and XB10-1843_CAC.patch not applied as code differ. Need to review this.
#bpi.patch contains workaround changes to fix build issues observed
